...
namespace ArgsTests
{
    ...
    {
        public const string BasicGridExpectedOutput = @"Id                                            StringValue                       
1                                             Some value here                   
2                                             Some value here                   
3                                             Some value here                   
4                                             Some value here                   
...
End                                                                             
        ...
        public const string PhotoAlbumManagerExpectedConsoleUsage = @"
...
Examples
    ...
    photos createalbum -a myaccount -k mykey -c wedding";
        ...
        public const string PhotoAlbumManagerExpectedBrowserUsage = @"<!DOCTYPE html>
