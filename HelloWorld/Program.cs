...
namespace HelloWorld
{
    class Program
    {
        ...
        {
            var def = new CommandLineArgumentsDefinition(typeof(HelloWorld.Samples.HelloWorldInvokeArgs));
            ArgUsage.GenerateUsageFromTemplate(def).Write();
            ArgUsage.ShowUsageInBrowser(def);
            var usage = ArgUsage.ShowUsageInBrowser<Program>();
